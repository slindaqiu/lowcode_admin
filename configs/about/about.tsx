        ...
        "items": [
          ...
          },
          {
            ...
            "body": [
              ...
              {
                "type": "tpl",
                "tpl": "<p>碳和科技（北京）有限公司，位于北京市北京经济技术开发区（通州），拥有近三十年PSA行业经验，以二氧化碳捕集回收应用为出发点，开发了二氧化碳捕集利用、煤层气、甲烷等温室气体的治理和分离以及CO、H2等工业尾气的回收利用等多种气体净化回收技术，集技术研发、工程设计、设备制造、安装调试、EPC总包、EP承包及技术优化升级改造服务于一体。</p>"
              },
              {
                "type": "wrapper",
                "style": {
              ...
              {
                "type": "tpl",
                "tpl": `<p>碳和科技属于北京市飞达捷能气体分离技术有限公司控股子公司，公司以研发为基石，与国内多所高校和科研院所建立了紧密的研发合作关系，先后取得了四十余项国家专利，研发生产出烟气提纯二氧化碳、变压吸附法制氮、制氧、制氢，煤层气提纯甲烷，以及气体净化干燥等多种工艺及装备，拥有自主知识产权的核心吸附材料，具备中试及产业化所需的工艺开发、设备制造、分析检测等条件，拥有较强的研发成果转化能力和丰富的工程化经验。
